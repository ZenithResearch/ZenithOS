...
### Changed
- Changed Matrix to default to the Zenith production homeserver, with an explicit restart-safe Local Development selection shared by human and Sophia clients.
